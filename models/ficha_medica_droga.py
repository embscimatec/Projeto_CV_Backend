...
class FichaMedicaDrogaModel(banco.Model):
    ...
    frequencia_uso = banco.Column(banco.Enum("nuca", "até uma vez por mês", "duas a quatro vezes por mês", " duas a três vezes por semana", "quatro ou mais vezes por semana"))
    ...
    def __init__(self, frequencia_uso, ficha_medica_id):
